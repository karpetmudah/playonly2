...
export enum I18nKey {
  ...
  BILLING$SKIP_FOR_NOW = "BILLING$SKIP_FOR_NOW",
  ...
  AUTH$WELCOME_TO_OPENHANDS = "AUTH$WELCOME_TO_OPENHANDS",
  AUTH$SUBTITLE = "AUTH$SUBTITLE",
  AUTH$LOGIN_TITLE = "AUTH$LOGIN_TITLE",
  AUTH$REGISTER_TITLE = "AUTH$REGISTER_TITLE",
  ...
  AUTH$FULL_NAME_PLACEHOLDER = "AUTH$FULL_NAME_PLACEHOLDER",
  AUTH$LOGIN = "AUTH$LOGIN",
  AUTH$REGISTER = "AUTH$REGISTER",
  AUTH$LOGGING_IN = "AUTH$LOGGING_IN",
  AUTH$REGISTERING = "AUTH$REGISTERING",
  AUTH$LOGIN_SUCCESS = "AUTH$LOGIN_SUCCESS",
  AUTH$REGISTER_SUCCESS = "AUTH$REGISTER_SUCCESS",
  AUTH$LOGIN_ERROR = "AUTH$LOGIN_ERROR",
  AUTH$REGISTER_ERROR = "AUTH$REGISTER_ERROR",
  AUTH$PASSWORD_MISMATCH = "AUTH$PASSWORD_MISMATCH",
  AUTH$PASSWORD_TOO_SHORT = "AUTH$PASSWORD_TOO_SHORT",
